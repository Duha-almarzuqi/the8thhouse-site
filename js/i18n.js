(function () {
  ...
  var T = {
    ar: {
      ...
      about_body:       '"البيت الثامن" شركة متخصصة في <strong>إدارة وتشغيل</strong> الشقق السكنية المؤثثة بمدينة الرياض. نقدّم للمُلّاك حلول تشغيل متكاملة تضمن لهم <strong>نسبة إشغال عالية</strong>، <strong>تشغيل احترافي</strong> و<strong>صيانة مستمرة</strong> للعقار، مع <strong>شفافية كاملة</strong> في التقارير والعوائد.',
      about_pillar_1:   'إشغال عالٍ',
      about_pillar_2:   'تشغيل احترافي',
      about_pillar_3:   'شفافية كاملة',

      vm_vision_title:  'رؤيتنا',
      vm_vision_body:   'أن نكون <strong>الاختيار الأول</strong> لمُلّاك الشقق في الرياض، عبر تحويل عقاراتهم إلى <strong>أصول عالية العائد</strong> تُدار <strong>باحترافية وموثوقية</strong> تضاهي أرقى معايير الضيافة العالمية.',
      vm_mission_title: 'رسالتنا',
      vm_mission_body:  'في البيت الثامن رسالتنا هي إدارة وتشغيل الشقق السكنية المؤثثة باحترافية عالية، من خلال <strong>رفع نسب الإشغال</strong>، ضمان <strong>تجربة ضيافة راقية</strong>، وحماية أصول المُلّاك عبر <strong>إدارة مالية شفافة</strong> وصيانة مستمرة، لنحقق لهم <strong>دخلاً مستقراً</strong> وشراكة طويلة الأمد مبنية على الثقة.',
      ...
      j2_desc:  'نقوم بزيارة الشقة (أو استلام تفاصيلها) وتقييم جاهزيتها للتشغيل، مع تقديم <strong>مقترح تفصيلي</strong> يتضمن التأثيث المناسب، التسويق، و<strong>العوائد المتوقعة</strong>.',
      j3_title: 'توقيع العقد',
      j3_desc:  'نبرم <strong>عقد شراكة واضح وشفاف</strong>، يحدد <strong>نسب العوائد</strong>، مسؤوليات الطرفين، وفترة التشغيل.',
      j4_title: 'التأثيث والتجهيز',
      j4_desc:  'يتم تأثيث الشقة وتنسيقها داخلياً حسب <strong>معايير Airbnb</strong> والضيافة الراقية، مع <strong>جلسة تصوير احترافية</strong>.',
      j5_title: 'الإطلاق والتسويق',
      j5_desc:  'إدراج الشقة على <strong>المنصات العالمية</strong> مثل Airbnb وتفعيل <strong>نظام التسعير الديناميكي</strong>.',
      j6_title: 'إدارة الحجوزات والضيوف',
      j6_desc:  'استقبال الضيوف، متابعة إقامتهم، التنظيف الدوري، وخدمة العملاء <strong>على مدار الساعة</strong>.',
      j7_title: 'التقارير والعوائد',
      j7_desc:  'تزويد المالك بـ<strong>تقارير شهرية شفافة</strong> عن نسب الإشغال، <strong>العوائد</strong>، وحالة العقار.',
