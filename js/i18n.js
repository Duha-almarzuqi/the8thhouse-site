(function () {
  ...
  var T = {
    ar: {
      ...
      about_label:      'من نحن',
      about_title:      'شراكة حقيقية مع ملاك العقارات المؤثثة',
      about_body:       '<strong>البيت الثامن</strong> شركة متخصصة في إدارة و<strong>تشغيل العقارات السكنية</strong> المؤثثة بمدينة الرياض. نقدّم للمُلّاك حلول تشغيل متكاملة تضمن لهم <strong>نسبة إشغال عالية</strong>، تشغيل احترافي وصيانة مستمرة للعقار، مع <strong>شفافية كاملة</strong> في التقارير والعوائد.',
      about_pillar_1:   'إشغال عالٍ',
      about_pillar_2:   'تشغيل احترافي',
      about_pillar_3:   'شفافية كاملة',

      vm_vision_title:  'رؤيتنا',
      vm_vision_body:   'أن نكون الاختيار الأول لمُلّاك العقارات في الرياض، عبر تحويل عقاراتهم إلى أصول عالية العائد تُدار باحترافية وموثوقية تضاهي أرقى معايير الضيافة العالمية.',
      vm_mission_title: 'رسالتنا',
      vm_mission_body:  'في البيت الثامن رسالتنا هي إدارة وتشغيل العقارات السكنية المؤثثة باحترافية عالية، من خلال رفع نسب الإشغال، ضمان تجربة ضيافة راقية، وحماية أصول المُلّاك عبر <strong>إدارة مالية شفافة</strong> وصيانة مستمرة، لنحقق لهم <strong>دخلاً مستقراً</strong> وشراكة طويلة الأمد مبنية على الثقة.',
      ...
      property_title:   'نماذج من عقاراتنا<br>في حي الملقا · الرياض',
      ...
      svc3_bullets:     '<li>متابعة الصيانة الوقائية</li><li>ضمان معايير استخدام تحافظ على جودة العقار ومحتوياتها</li>',
      ...
      why_b3_desc:      'فريق متخصص في إدارة وتأجير العقارات.',
      ...
      j2_desc:  'نقوم بزيارة العقار (أو استلام تفاصيلها) وتقييم جاهزيتها للتشغيل، مع تقديم مقترح تفصيلي يتضمن التأثيث المناسب، التسويق، و<strong>العوائد المتوقعة</strong>.',
      ...
      j4_desc:  'يتم تأثيث العقار وتنسيقها داخلياً حسب معايير Airbnb والضيافة الراقية، مع جلسة تصوير احترافية.',
      j5_title: 'الإطلاق والتسويق',
      j5_desc:  'إدراج العقار على المنصات العالمية مثل Airbnb وتفعيل نظام التسعير الديناميكي.',
      ...
      lm_pt_villa:          'فيلا',
      lm_pt_chalet:         'شاليه',
      lm_count_label:       'عدد العقارات',
      lm_count_placeholder: 'مثال: 3',
      lm_rooms_label:       'عدد الغرف',
      lm_rooms_ph:          'مثال: 2',
      ...
      faq_a2: 'لا يلزمك ذلك من البداية. نقدم لك استشارة متخصصة لاختيار التأثيث الملائم لمعايير التأجير القصير، مع توجيهك نحو أنسب الخيارات التي تعزز <strong>عوائد عقارك</strong> وتعكس مستوى الضيافة الذي نلتزم به.',

      faq_q3: 'كيف أتابع أداء عقاري وعوائدها الشهرية؟',
      faq_a3: 'تصلك <strong>تقارير شهرية شفافة</strong> تشمل: نسبة الإشغال، العوائد الصافية، أداء المنصات، وحالة الصيانة — دون أي تعقيد.',

      faq_q4: 'ماذا يحدث إذا تعرضت العقار لضرر من الضيوف؟',
      ...
      faq_q6: 'هل يمكنني استخدام عقاري لأغراض شخصية؟',
      ...
      footer_tagline: 'إدارة وتشغيل العقارات المؤثثة · الرياض',
      footer_nav1:    'التنقل',
      footer_nav2:    'تواصل',
    ...
    en: {
      ...
      about_title:      'A True Partnership with Furnished Property Owners',
      ...
      vm_vision_body:   'To be the first choice for property owners in Riyadh — transforming their properties into high-yield assets managed with the professionalism and reliability that match the finest global hospitality standards.',
      vm_mission_title: 'Our Mission',
      vm_mission_body:  'At The 8th House, our mission is to manage and operate furnished residential properties with the highest level of professionalism — raising occupancy rates, ensuring a premium hospitality experience, and protecting owners\' assets through <strong>transparent financial management</strong> and ongoing maintenance, delivering a <strong>stable income stream</strong> built on a long-term partnership of trust.',
      ...
      svc3_bullets:     '<li>Preventive maintenance monitoring</li><li>Usage standards that preserve property quality and its furnishings</li>',
      ...
      why_b3_desc:      'A specialist team dedicated to property management and operations.',
      ...
      j2_desc:  'We visit the property (or receive its details) and assess its operational readiness, with a <strong>detailed proposal</strong> covering furnishing, marketing, and <strong>expected returns</strong>.',
      ...
      j4_desc:  'The property is furnished and styled to <strong>Airbnb and premium hospitality standards</strong> — with advisory guidance from our team if needed — followed by a <strong>professional photography session</strong>.',
      j5_title: 'Launch & Marketing',
      j5_desc:  'The property is listed on <strong>global platforms</strong> such as Airbnb with <strong>dynamic pricing</strong> activated.',
      ...
      lm_pt_villa:          'Villa',
      lm_pt_chalet:         'Chalet',
      lm_count_label:       'Number of Properties',
      lm_count_placeholder: 'e.g. 3',
      lm_rooms_label:       'Number of Rooms',
      lm_rooms_ph:          'e.g. 2',
      ...
      faq_a2: 'Not necessarily. We provide specialist consultancy on the right furnishing choices for short-term rental standards, guiding you toward options that maximise your property\'s <strong>returns</strong> and reflect the hospitality level we commit to.',

      faq_q3: 'How do I track my property\'s performance and monthly returns?',
      ...
      faq_q4: 'What happens if my property is damaged by guests?',
      ...
      faq_q6: 'Can I use my property for personal purposes?',
      ...
      footer_whatsapp: 'WhatsApp',
      footer_tagline: 'Furnished Property Management · Riyadh',
