(function () {
  ...
  var T = {
    ar: {
      ...
      about_body:       '<strong>البيت الثامن</strong> شركة متخصصة في إدارة وتشغيل الشقق السكنية المؤثثة بمدينة الرياض. نقدّم للمُلّاك حلول تشغيل متكاملة تضمن لهم <strong>نسبة إشغال عالية</strong>، تشغيل احترافي وصيانة مستمرة للعقار، مع <strong>شفافية كاملة</strong> في <strong>التقارير والعوائد</strong>.',
