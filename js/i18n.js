(function () {
  ...
  var T = {
    ar: {
      ...
      svc3_bullets:     '<li>متابعة الصيانة الوقائية</li><li>ضمان معايير استخدام تحافظ على جودة العقار ومحتوياته</li>',
      ...
      j2_desc:  'نقوم بزيارة العقار (أو استلام تفاصيله) وتقييم جاهزيته للتشغيل، مع تقديم مقترح تفصيلي يتضمن التأثيث المناسب، التسويق، و<strong>العوائد المتوقعة</strong>.',
      ...
      j4_desc:  'يتم تأثيث العقار وتنسيقه داخلياً حسب معايير Airbnb والضيافة الراقية، مع جلسة تصوير احترافية.',
